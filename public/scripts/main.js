...
function loadMessages() {
        ...
        function onScienceFormSubmit(e) {
          ...
          setTimeout(() => scienceButtonElement.removeAttribute('disabled'),
                     1000);
        }
        ...
        function onShipsFormSubmit(e) {
          ...
          setTimeout(() => shipsButtonElement.removeAttribute('disabled'),
                     1000);
        }
        ...
        function onApplauseFormSubmit(e) {
          ...
          setTimeout(() => applauseButtonElement.removeAttribute('disabled'),
                     1000);
        }
        ...
        function displayMessage(id, timestamp, name, text, picUrl, videoUrl) {
          ...
          if (text) { // If the message is text.
            ...
            mp4.src = videoUrl;
            mp4.type = 'video/mp4';
            let fallback = document.createTextNode(
        ...
        const youtubeStreamIframeElement =
            document.getElementById('youtube-stream');
        ...
        const callbacks = [
          ...
          new Callback(
              ...
              '🚢',
              [
                'ships1.mp4', 'ships2.mp4', 'ships3.mp4', 'ships4.mp4',
                'ships5.mp4', 'ships6.mp4'
              ],
              shipsAudioElement),
          new Callback(
              '👏',
